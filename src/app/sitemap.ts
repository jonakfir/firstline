...
export default function sitemap(): MetadataRoute.Sitemap {
  const baseUrl = 'https://firstline.io';
  const now = new Date();
  return [
    { url: `${baseUrl}/`, lastModified: now, changeFrequency: 'weekly', priority: 1.0 },
    { url: `${baseUrl}/privacy`, lastModified: now, changeFrequency: 'weekly', priority: 0.6 },
    { url: `${baseUrl}/terms`, lastModified: now, changeFrequency: 'weekly', priority: 0.6 },
  ];
}
